...
public class RSInterface {
			...
			if (rsInterface.type == 0) {
				...
				if (rsInterface.parentID == 5608) {
					...
					for (int index = 0; index < length; index++) {
						...
						rsInterface.childX[BEGIN_READING_PRAYER_INTERFACE + index] = stream.readSignedShort();
						rsInterface.childY[BEGIN_READING_PRAYER_INTERFACE + index] = stream.readSignedShort();
					}
				} else {
	...
	static void addProgressBar(int id, double percentage, int width, int height, boolean displayPercent, boolean pulsate) {
		RSInterface rsi = addTabInterface(id);
		rsi.interfaceId = id;
		rsi.parentID = id;
		rsi.percentage = percentage;
	...
	private enum Runes {
		FIRE(554, new int[] {4, 3214, 554, 4, 3214, 4694, 4, 3214, 4697, 4, 3214, 4699, 10, 1688, 1387, 10, 1688, 1393, 10, 1688, 1401, 10, 1688, 3053, 10, 1688, 3054, 0}),
		WATER(555, new int[] {4, 3214, 555, 4, 3214, 4694, 4, 3214, 4695, 4, 3214, 4698, 10, 1688, 1383, 10, 1688, 1395, 10, 1688, 1403, 10, 1688, 6562, 10, 1688, 6563, 0}),
		AIR(556, new int[] {4, 3214, 556, 4, 3214, 4697, 4, 3214, 4695, 4, 3214, 4696, 10, 1688, 1381, 10, 1688, 1397, 10, 1688, 1405, 0}),
		EARTH(557, new int[] {4, 3214, 557, 4, 3214, 4696, 4, 3214, 4699, 4, 3214, 4698, 10, 1688, 1385, 10, 1688, 1399, 10, 1688, 1407, 10, 1688, 3053, 10, 1688, 3054, 10, 1688, 6562, 10, 1688, 6563, 0}),
	...
	private enum SpellData {
		...
		FIRE_WAVE("Fire Wave", "A high level Fire missile", 74, new int[][] {{554, 6, FIRE}, {554, 4, AIR}, {565, 0, SOUL}}, 10, 2),
