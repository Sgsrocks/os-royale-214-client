...
import static com.osroyale.ParticleDefinition.RANDOM;
...
public class Utility {
    ...
    public static String findcachedir() {
        ...
        return System.getProperty("user.home") + "/" + Configuration.CACHE_NAME + "/";
    }

    private static String secondDir() {
        File file = new File("c:/" + Configuration.CACHE_NAME + "/");
    ...
    static void captureScreen() {
        try {
            ...
            String path = System.getProperty("user.home") + "/Desktop/RunePK Screenshots/Screenshot ";
...
//                    Client.instance.captureDelay = Client.tick + 150;
            ...
            Client.instance.pushMessage("Screenshot was taken successfully - " + getDate());
        } catch (Exception e) {
            e.printStackTrace();
            Client.instance.pushMessage("There was an issue taking your screenshot!");
        }
    }
