...
public class SkillOrb {
	...
	public void draw(int x, int y) {
		...
		Raster.setDrawingArea2(60 + y, x + 1, x + 30, 45 - (currentLevel() >= 99 ? 100 : percentProgress) + 1 + y);
		Client.spriteCache.get(744).drawARGBSprite(x + 1, 1 + y, alpha);
		Raster.setDrawingArea2((currentLevel() >= 99 ? 100 : percentProgress) - 38 + y, x + 30, x + 56, 1 + y);
