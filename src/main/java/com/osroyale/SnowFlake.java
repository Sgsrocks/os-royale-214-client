...
public class SnowFlake {
	...
	public void draw(int x, int y) {
		Raster.fillCircle(this.x + x - (this.radius / 2), this.y + y - (this.radius / 2), radius, 0xFFFFFF, this.alpha);
	}

	public void reset() {
		this.x = random(Client.frameMode == ScreenMode.FIXED ? 765 : Client.frameWidth);
		this.y = -10;
		this.cycle = 0;
		this.moving = true;
		this.touched = false;
