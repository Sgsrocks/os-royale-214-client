...
public class ModelLoader {
    ...
    public static void decodeType3(Model def, byte[] var1)
    {
        ...
        for (var51 = 0; var51 < var9; ++var51)
        {
            ...
            if (var17 == 1)
            {
                def.vertexData[var51] = var6.readUByte();
            }
        }
        ...
        for (var51 = 0; var51 < var10; ++var51)
        {
            ...
            if (var15 == 1)
            {
                def.triangleData[var51] = var6.readUByte();
            }
            ...
            {
                def.textures[var51] = (byte) (var8.readUByte() - 1);
            }
        }
    ...
    public static void decodeType2(Model def, byte[] var1)
    {
        ...
        for (var40 = 0; var40 < var9; ++var40)
        {
            ...
            if (var16 == 1)
            {
                def.vertexData[var40] = var8.readUByte();
            }
        }
        ...
        if (var17 == 1)
        {
            for (var40 = 0; var40 < var9; ++var40)
            {
                ...
                {
                    def.animayaGroups[var40][var42] = var8.readUByte();
                    def.animayaScales[var40][var42] = var8.readUByte();
                }
            }
        }
        ...
        for (var40 = 0; var40 < var10; ++var40)
        {
            ...
            if (var15 == 1)
            {
                def.triangleData[var40] = var8.readUByte();
            }
        }
    ...
    public static void decodeType1(Model def, byte[] var1)
    {
        ...
        for (var49 = 0; var49 < var9; ++var49)
        {
            ...
            if (var17 == 1)
            {
                def.vertexData[var49] = var6.readUByte();
            }
        }
        ...
        for (var49 = 0; var49 < var10; ++var49)
        {
            ...
            if (var15 == 1)
            {
                def.triangleData[var49] = var6.readUByte();
            }
            ...
            {
                def.textures[var49] = (byte) (var8.readUByte() - 1);
            }
        }
    ...
    public static void decodeOldFormat(Model def, byte[] var1)
    {
        ...
        for (var38 = 0; var38 < var9; ++var38)
        {
            ...
            if (var16 == 1)
            {
                def.vertexData[var38] = var8.readUByte();
            }
        }
        ...
        for (var38 = 0; var38 < var10; ++var38)
        {
            ...
            if (var15 == 1)
            {
                def.triangleData[var38] = var8.readUByte();
            }
        }
