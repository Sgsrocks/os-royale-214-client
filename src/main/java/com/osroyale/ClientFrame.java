...
import static com.osroyale.Utility.launchURL;
...
public class ClientFrame extends Client {
    ...
    private static final int TEXT_COLOR = 0x1F5A61;
    ...
    private void initializeUserInterface() {
        try {
			 ...
			 */
            frame = new JFrame(Configuration.NAME);
            ...
            frame.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosing(WindowEvent we) {
                    ...
                    msgPanel.add(new JLabel("Are you sure you wish to exit?"), BorderLayout.NORTH);
                    JCheckBox jcb = new JCheckBox("Do not ask me again");
                    msgPanel.add(jcb, BorderLayout.SOUTH);
                    msgPanel.add(new Label());

                    int userPrompt = JOptionPane.showConfirmDialog(null , msgPanel, Configuration.NAME, JOptionPane.OK_CANCEL_OPTION);
                   ...
                   // int userPrompt = JOptionPane.showOptionDialog(null, "Are you sure you wish to exit?", Configuration.NAME, JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[1]);
                    if (jcb.isSelected())
                    {
                        Settings.PROMPT_ON_CLOSE = false;
                    }
