...
public class Announcement {
    ...
    Announcement(Client client, String title, String context, int firstColor, int secondColor) {
        ...
        this.firstTime = 0;
        this.secondTime = 0;
        this.firstLinePosition = Client.frameWidth - (Client.frameMode == Client.ScreenMode.FIXED ? 253 : 155);
    ...
    public void update() {
        ...
        int width = Client.frameWidth - (Client.frameMode == Client.ScreenMode.FIXED ? 253 : 155);
        int delta = 4 * (1 << (int) (width / (765.0 - (Client.frameMode == Client.ScreenMode.FIXED ? 253 : 155))));
