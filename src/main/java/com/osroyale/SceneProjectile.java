...
public final class SceneProjectile extends Renderable {
	...
	private final Graphic aSpotAnim_1592;
	...
	public Model getRotatedModel() {
		...
		if (aSpotAnim_1592.aAnimation_407 != null) {
			j = aSpotAnim_1592.aAnimation_407.primary[anInt1593];
		}
	...
	public SceneProjectile(int i, int j, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2) {
		aBoolean1579 = false;
		aSpotAnim_1592 = Graphic.cache[l2];
		anInt1597 = k1;
		anInt1580 = j2;
		anInt1581 = i2;
		anInt1582 = l1;
	...
	public void method456(int i) {
		...
		if (aSpotAnim_1592.aAnimation_407 != null) {
			for (anInt1594 += i; anInt1594 > aSpotAnim_1592.aAnimation_407.method258(anInt1593); ) {
				...
				anInt1593++;
				if (anInt1593 >= aSpotAnim_1592.aAnimation_407.length) {
					anInt1593 = 0;
				}
			}
		}
