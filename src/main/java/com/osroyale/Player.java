...
import static com.osroyale.Model.modelIntArray3;
...
public final class Player extends Entity {
    ...
    public Model getRotatedModel() {
        ...
        if (super.graphic != -1 && super.currentAnimation != -1) {
             ...
             */
            if (Frame.animationlist[spotAnim.aAnimation_407.primary[0] >> 16].length == 0) {
            ...
            if (spotAnimationModel != null) {
                ...
                model_3.skin();
                model_3.method470(spotAnim.aAnimation_407.primary[super.currentAnimation]);
    ...
    Model method452() {
        ...
        if (desc != null) {
            ...
            if (super.emoteAnimation >= 0 && super.animationDelay == 0) {
                ...
                if (Settings.TWEENING && super.nextAnimFrame != -1) {
                    nextAnim = seq.primary[super.displayedEmoteFrames];
        ...
        if (super.emoteAnimation >= 0 && super.animationDelay == 0) {
            ...
            currAnim = animation.primary[super.displayedEmoteFrames];
            if (Settings.TWEENING && super.nextAnimFrame != -1) {
                nextAnim = animation.primary[super.nextAnimFrame];
                currCycle = animation.duration[super.displayedEmoteFrames];
                nextCycle = super.emoteTimeRemaining;
            }
            if (super.movementAnimation >= 0 && super.movementAnimation != super.idleAnimation) {
                i1 = Animation.animations[super.movementAnimation].primary[super.anInt1518];
            }
        ...
        model_2.replace(model_1, Frame.method532(currAnim) & Frame.method532(i1));
        if (currAnim != -1 && i1 != -1) {
