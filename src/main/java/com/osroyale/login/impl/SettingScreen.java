...
public class SettingScreen extends LoginComponent {
	...
	public void render(Client client) {
		...
		client.boldText.drawCenteredText(0x27A2B0, centerX + 5, "RunePK", centerY - 105, true);
		...
		if (client.mouseInRegion(centerX - 47, centerY - 37, centerX + 51, centerY - 9)) {
			Raster.fillRectangle(336, 215, 100, 30, 0x1FB2C2, 105);
			Raster.drawRectangle(336, 215, 100, 30, 0x22747D);
		} else {
			Raster.fillRectangle(336, 215, 100, 30, 0x12494F, 105);
			Raster.drawRectangle(336, 215, 100, 30, 0x22747D);
		}
		...
		if (client.mouseInRegion(centerX - 47, centerY + 24, centerX + 58, centerY + 64)) {
			Raster.fillRectangle(336, 280, 100, 30, 0x1FB2C2, 105);
			Raster.drawRectangle(336, 280, 100, 30, 0x22747D);
		} else {
			Raster.fillRectangle(336, 280, 100, 30, 0x12494F, 105);
			Raster.drawRectangle(336, 280, 100, 30, 0x22747D);
		}
		...
		if (client.mouseInRegion(centerX - 47, centerY + 95, centerX + 58, centerY + 120)) {
			Raster.fillRectangle(336, 345, 100, 30, 0x1FB2C2, 105);
			Raster.drawRectangle(336, 345, 100, 30, 0x22747D);
		} else {
			Raster.fillRectangle(336, 345, 100, 30, 0x12494F, 105);
			Raster.drawRectangle(336, 345, 100, 30, 0x22747D);
		}
	...
	public void click(Client client) {
		...
		if (client.lastMetaModifier == 1 && client.mouseInRegion(centerX - 47, centerY + 95, centerX + 58, centerY + 120)) {
