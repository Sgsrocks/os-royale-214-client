...
class AnnouncementManager {
    ...
    void draw() {
        if (isActive()) {
            ...
            Raster.drawAlphaGradient(0, YPOSITION, Client.frameWidth, 50, message.getFirstColor(), message.getFirstColor(), messageFade);
            Raster.drawRectangle(0, YPOSITION, Client.frameWidth, 50, 0x000000, messageFade);
