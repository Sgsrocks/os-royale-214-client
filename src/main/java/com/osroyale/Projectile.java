...
final class Projectile extends Renderable {
	...
	public Model getRotatedModel() {
		...
		int frame = aSpotAnim_1568.aAnimation_407.primary[anInt1569];
		Model model_1 = new Model(true, Frame.method532(frame), false, model);
		if (!aBoolean1567) {
			model_1.skin();
			if (Settings.TWEENING && nextAnimFrameId != -1) {
				model_1.interpolateFrames(frame, aSpotAnim_1568.aAnimation_407.primary[nextAnimFrameId], anInt1570, aSpotAnim_1568.aAnimation_407.duration[anInt1569]);
			} else {
	...
	public void method454(int i) {
		for (anInt1570 += i; anInt1570 > aSpotAnim_1568.aAnimation_407.method258(anInt1569); ) {
			...
			anInt1569++;
			if (anInt1569 >= aSpotAnim_1568.aAnimation_407.length && (anInt1569 < 0 || anInt1569 >= aSpotAnim_1568.aAnimation_407.length)) {
				anInt1569 = 0;
				aBoolean1567 = true;
			}
			...
			if (nextAnimFrameId >= aSpotAnim_1568.aAnimation_407.length) {
				nextAnimFrameId = -1;
			}
		}
	}
