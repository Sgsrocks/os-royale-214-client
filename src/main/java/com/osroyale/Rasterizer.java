...
public final class Rasterizer extends Raster {
	...
	public static void method364() {
		anIntArray1472 = new int[Raster.height];
		for (int j = 0; j < Raster.height; j++) {
			anIntArray1472[j] = Raster.width * j;
		}
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && dx3 < dx1 || y1 == y2 && dx3 > dx2) {
					...
					while (--y3 >= 0) {
						drawLDGouraudScanline(Raster.pixels, y1, x3 >> 16, x2 >> 16, hsl3 >> 7, hsl2 >> 7, z1, depthSlope);
						z1 += depthScale;
						x3 += dx3;
						x2 += dx2;
						hsl3 += dhsl3;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && dx1 < dx2 || y2 == y3 && dx1 > dx3) {
					...
					while (--y1 >= 0) {
						drawLDGouraudScanline(Raster.pixels, y2, x1 >> 16, x3 >> 16, hsl1 >> 7, hsl3 >> 7, z2, depthSlope);
						z2 += depthScale;
						x1 += dx1;
						x3 += dx3;
						hsl1 += dhsl1;
	...
	public static void drawHDGouraudTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2, int hsl3, int z1, int z2, int z3) {
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && dx3 < dx1 || y1 == y2 && dx3 > dx2) {
					...
					y2 -= y1;
					for (y1 = anIntArray1472[y1]; --y2 >= 0; y1 += Raster.width) {
						drawHDGouraudScanline(Raster.pixels, y1, x3 >> 16, x1 >> 16, r3, g3, b3, r1, g1, b1, z1, depthSlope);
						x3 += dx3;
						x1 += dx1;
						r3 += dr3;
						g3 += dg3;
					...
					while (--y3 >= 0) {
						drawHDGouraudScanline(Raster.pixels, y1, x3 >> 16, x2 >> 16, r3, g3, b3, r2, g2, b2, z1, depthSlope);
						x3 += dx3;
						x2 += dx2;
						r3 += dr3;
						g3 += dg3;
				...
				while (--y3 >= 0) {
					drawHDGouraudScanline(Raster.pixels, y1, x2 >> 16, x3 >> 16, r2, g2, b2, r3, g3, b3, z1, depthSlope);
					x3 += dx3;
					x2 += dx2;
					r3 += dr3;
					g3 += dg3;
			...
			if (y1 != y3 && dx3 < dx1 || y1 == y3 && dx2 > dx1) {
				...
				y3 -= y1;
				for (y1 = anIntArray1472[y1]; --y3 >= 0; y1 += Raster.width) {
					drawHDGouraudScanline(Raster.pixels, y1, x2 >> 16, x1 >> 16, r2, g2, b2, r1, g1, b1, z1, depthSlope);
					x2 += dx3;
					x1 += dx1;
					r2 += dr3;
					g2 += dg3;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && dx1 < dx2 || y2 == y3 && dx1 > dx3) {
					...
					y3 -= y2;
					for (y2 = anIntArray1472[y2]; --y3 >= 0; y2 += Raster.width) {
						drawHDGouraudScanline(Raster.pixels, y2, x1 >> 16, x2 >> 16, r1, g1, b1, r2, g2, b2, z2, depthSlope);
						x1 += dx1;
						x2 += dx2;
						r1 += dr1;
						g1 += dg1;
					...
					while (--y1 >= 0) {
						drawHDGouraudScanline(Raster.pixels, y2, x1 >> 16, x3 >> 16, r1, g1, b1, r3, g3, b3, z2, depthSlope);
						x1 += dx1;
						x3 += dx3;
						r1 += dr1;
						g1 += dg1;
				...
				while (--y1 >= 0) {
					drawHDGouraudScanline(Raster.pixels, y2, x3 >> 16, x1 >> 16, r3, g3, b3, r1, g1, b1, z2, depthSlope);
					x1 += dx1;
					x3 += dx3;
					r1 += dr1;
					g1 += dg1;
			...
			if (dx1 < dx2) {
				...
				y1 -= y2;
				for (y2 = anIntArray1472[y2]; --y1 >= 0; y2 += Raster.width) {
					drawHDGouraudScanline(Raster.pixels, y2, x3 >> 16, x2 >> 16, r3, g3, b3, r2, g2, b2, z2, depthSlope);
					x3 += dx1;
					x2 += dx2;
					r3 += dr1;
					g3 += dg1;
		...
		if (y1 < y2) {
			...
			if (dx2 < dx3) {
				...
				while (--y2 >= 0) {
					drawHDGouraudScanline(Raster.pixels, y3, x2 >> 16, x1 >> 16, r2, g2, b2, r1, g1, b1, z3, depthSlope);
					x2 += dx2;
					x1 += dx1;
					r2 += dr2;
					g2 += dg2;
	...
	public static void drawTexturedTriangle317(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3, int t1, int t2, int t3, int t4, int t5, int t6, int t7, int t8, int t9, int tex, int z1, int z2, int z3) {
		...
		t6 -= t4;
		t9 -= t7;
		int l4 = (t3 * t4 - t6 * t1) * SceneGraph.focalLength << 5;
		int i5 = t6 * t7 - t9 * t4 << 8;
		int j5 = t9 * t1 - t3 * t7 << 5;
		int k5 = (t2 * t4 - t5 * t1) * SceneGraph.focalLength << 5;
		int l5 = t5 * t7 - t8 * t4 << 8;
		int i6 = t8 * t1 - t2 * t7 << 5;
		int j6 = (t5 * t3 - t2 * t6) * SceneGraph.focalLength << 5;
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
					...
					while (--y2 >= 0) {
						drawTexturedScanline317(Raster.pixels, texels, y1, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4, k5, j6, i5, l5, k6, z1, depthSlope);
						z1 += depthScale;
						x3 += i8;
						x1 += i7;
						c3 += j8;
					...
					while (--y3 >= 0) {
						drawTexturedScanline317(Raster.pixels, texels, y1, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5, j6, i5, l5, k6, z1, depthSlope);
						z1 += depthScale;
						x3 += i8;
						x2 += k7;
						c3 += j8;
				...
				y1 = anIntArray1472[y1];
				while (--y2 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y1, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5, j6, i5, l5, k6, z1, depthSlope);
					z1 += depthScale;
					x3 += i8;
					x1 += i7;
					c3 += j8;
				...
				while (--y3 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y1, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5, j6, i5, l5, k6, z1, depthSlope);
					z1 += depthScale;
					x3 += i8;
					x2 += k7;
					c3 += j8;
			...
			if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
				...
				y1 = anIntArray1472[y1];
				while (--y3 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y1, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5, j6, i5, l5, k6, z1, depthSlope);
					z1 += depthScale;
					x2 += i8;
					x1 += i7;
					c2 += j8;
			...
			y1 = anIntArray1472[y1];
			while (--y3 >= 0) {
				drawTexturedScanline317(Raster.pixels, texels, y1, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5, j6, i5, l5, k6, z1, depthSlope);
				z1 += depthScale;
				x2 += i8;
				x1 += i7;
				c2 += j8;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
					...
					while (--y3 >= 0) {
						drawTexturedScanline317(Raster.pixels, texels, y2, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5, j6, i5, l5, k6, z2, depthSlope);
						z2 += depthScale;
						x1 += i7;
						x2 += k7;
						c1 += j7;
					...
					while (--y1 >= 0) {
						drawTexturedScanline317(Raster.pixels, texels, y2, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5, j6, i5, l5, k6, z2, depthSlope);
						z2 += depthScale;
						x1 += i7;
						x3 += i8;
						c1 += j7;
				...
				y2 = anIntArray1472[y2];
				while (--y3 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y2, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5, j6, i5, l5, k6, z2, depthSlope);
					z2 += depthScale;
					x1 += i7;
					x2 += k7;
					c1 += j7;
				...
				while (--y1 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y2, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4, k5, j6, i5, l5, k6, z2, depthSlope);
					z2 += depthScale;
					x1 += i7;
					x3 += i8;
					c1 += j7;
			...
			if (i7 < k7) {
				...
				y2 = anIntArray1472[y2];
				while (--y1 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y2, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5, j6, i5, l5, k6, z2, depthSlope);
					z2 += depthScale;
					x3 += i7;
					x2 += k7;
					c3 += j7;
			...
			y2 = anIntArray1472[y2];
			while (--y1 >= 0) {
				drawTexturedScanline317(Raster.pixels, texels, y2, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5, j6, i5, l5, k6, z2, depthSlope);
				z2 += depthScale;
				x3 += i7;
				x2 += k7;
				c3 += j7;
		...
		if (y1 < y2) {
			...
			if (k7 < i8) {
				...
				while (--y1 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y3, x2 >> 16, x3 >> 16, c2 >> 8, c3 >> 8, l4, k5, j6, i5, l5, k6, z3, depthSlope);
					z3 += depthScale;
					x2 += k7;
					x3 += i8;
					c2 += l7;
				...
				while (--y2 >= 0) {
					drawTexturedScanline317(Raster.pixels, texels, y3, x2 >> 16, x1 >> 16, c2 >> 8, c1 >> 8, l4, k5, j6, i5, l5, k6, z3, depthSlope);
					z3 += depthScale;
					x2 += k7;
					x1 += i7;
					c2 += l7;
			...
			y3 = anIntArray1472[y3];
			while (--y1 >= 0) {
				drawTexturedScanline317(Raster.pixels, texels, y3, x3 >> 16, x2 >> 16, c3 >> 8, c2 >> 8, l4, k5, j6, i5, l5, k6, z3, depthSlope);
				z3 += depthScale;
				x2 += k7;
				x3 += i8;
				c2 += l7;
			...
			while (--y2 >= 0) {
				drawTexturedScanline317(Raster.pixels, texels, y3, x1 >> 16, x2 >> 16, c1 >> 8, c2 >> 8, l4, k5, j6, i5, l5, k6, z3, depthSlope);
				z3 += depthScale;
				x2 += k7;
				x1 += i7;
				c2 += l7;
		...
		if (k7 < i8) {
			...
			y3 = anIntArray1472[y3];
			while (--y2 >= 0) {
				drawTexturedScanline317(Raster.pixels, texels, y3, x1 >> 16, x3 >> 16, c1 >> 8, c3 >> 8, l4, k5, j6, i5, l5, k6, z3, depthSlope);
				z3 += depthScale;
				x1 += k7;
				x3 += i8;
				c1 += l7;
		...
		y3 = anIntArray1472[y3];
		while (--y2 >= 0) {
			drawTexturedScanline317(Raster.pixels, texels, y3, x3 >> 16, x1 >> 16, c3 >> 8, c1 >> 8, l4, k5, j6, i5, l5, k6, z3, depthSlope);
			z3 += depthScale;
			x1 += k7;
			x3 += i8;
			c1 += l7;
	...
	public static void drawTexturedTriangleold(int y1, int y2, int y3, int x1, int x2, int x3, int c1, int c2, int c3, int tx1, int tx2, int tx3, int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex, int z1, int z2, int z3) {
		if (!saveDepth) {
			z1 = z2 = z3 = 0;
		}
		...
		ty3 -= ty1;
		tz3 -= tz1;
		int l4 = (tx3 * ty1 - ty3 * tx1) * SceneGraph.focalLength << 5;
		int i5 = ty3 * tz1 - tz3 * ty1 << 8;
		int j5 = tz3 * tx1 - tx3 * tz1 << 5;
		int k5 = (tx2 * ty1 - ty2 * tx1) * SceneGraph.focalLength << 5;
		int l5 = ty2 * tz1 - tz2 * ty1 << 8;
		int i6 = tz2 * tx1 - tx2 * tz1 << 5;
		int j6 = (ty2 * tx3 - tx2 * ty3) * SceneGraph.focalLength << 5;
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
					...
					y1 = anIntArray1472[y1];
					while (--y2 >= 0) {
						drawTexturedScanline(Raster.pixels, texels, y1, x3 >> 16, x1 >> 16, c3, c1, l4, k5, j6, i5, l5, k6, z1, depthSlope);
						z1 += depthScale;
						x3 += i8;
						x1 += i7;
						c3 += j8;
					...
					while (--y3 >= 0) {
						drawTexturedScanline(Raster.pixels, texels, y1, x3 >> 16, x2 >> 16, c3, c2, l4, k5, j6, i5, l5, k6, z1, depthSlope);
						z1 += depthScale;
						x3 += i8;
						x2 += k7;
						c3 += j8;
				...
				y1 = anIntArray1472[y1];
				while (--y2 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y1, x1 >> 16, x3 >> 16, c1, c3, l4, k5, j6, i5, l5, k6, z1, depthSlope);
					z1 += depthScale;
					x3 += i8;
					x1 += i7;
					c3 += j8;
				...
				while (--y3 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y1, x2 >> 16, x3 >> 16, c2, c3, l4, k5, j6, i5, l5, k6, z1, depthSlope);
					z1 += depthScale;
					x3 += i8;
					x2 += k7;
					c3 += j8;
			...
			if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
				...
				y1 = anIntArray1472[y1];
				while (--y3 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y1, x2 >> 16, x1 >> 16, c2, c1, l4, k5, j6, i5, l5, k6, z1, depthSlope);
					z1 += depthScale;
					x2 += i8;
					x1 += i7;
					c2 += j8;
			...
			y1 = anIntArray1472[y1];
			while (--y3 >= 0) {
				drawTexturedScanline(Raster.pixels, texels, y1, x1 >> 16, x2 >> 16, c1, c2, l4, k5, j6, i5, l5, k6, z1, depthSlope);
				z1 += depthScale;
				x2 += i8;
				x1 += i7;
				c2 += j8;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
					...
					y2 = anIntArray1472[y2];
					while (--y3 >= 0) {
						drawTexturedScanline(Raster.pixels, texels, y2, x1 >> 16, x2 >> 16, c1, c2, l4, k5, j6, i5, l5, k6, z2, depthSlope);
						z2 += depthScale;
						x1 += i7;
						x2 += k7;
						c1 += j7;
					...
					while (--y1 >= 0) {
						drawTexturedScanline(Raster.pixels, texels, y2, x1 >> 16, x3 >> 16, c1, c3, l4, k5, j6, i5, l5, k6, z2, depthSlope);
						z2 += depthScale;
						x1 += i7;
						x3 += i8;
						c1 += j7;
				...
				y2 = anIntArray1472[y2];
				while (--y3 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y2, x2 >> 16, x1 >> 16, c2, c1, l4, k5, j6, i5, l5, k6, z2, depthSlope);
					z2 += depthScale;
					x1 += i7;
					x2 += k7;
					c1 += j7;
				...
				while (--y1 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y2, x3 >> 16, x1 >> 16, c3, c1, l4, k5, j6, i5, l5, k6, z2, depthSlope);
					z2 += depthScale;
					x1 += i7;
					x3 += i8;
					c1 += j7;
			...
			if (i7 < k7) {
				...
				y2 = anIntArray1472[y2];
				while (--y1 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y2, x3 >> 16, x2 >> 16, c3, c2, l4, k5, j6, i5, l5, k6, z2, depthSlope);
					z2 += depthScale;
					x3 += i7;
					x2 += k7;
					c3 += j7;
			...
			y2 = anIntArray1472[y2];
			while (--y1 >= 0) {
				drawTexturedScanline(Raster.pixels, texels, y2, x2 >> 16, x3 >> 16, c2, c3, l4, k5, j6, i5, l5, k6, z2, depthSlope);
				z2 += depthScale;
				x3 += i7;
				x2 += k7;
				c3 += j7;
		...
		if (y1 < y2) {
			...
			if (k7 < i8) {
				...
				y3 = anIntArray1472[y3];
				while (--y1 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y3, x2 >> 16, x3 >> 16, c2, c3, l4, k5, j6, i5, l5, k6, z3, depthSlope);
					z3 += depthScale;
					x2 += k7;
					x3 += i8;
					c2 += l7;
				...
				while (--y2 >= 0) {
					drawTexturedScanline(Raster.pixels, texels, y3, x2 >> 16, x1 >> 16, c2, c1, l4, k5, j6, i5, l5, k6, z3, depthSlope);
					z3 += depthScale;
					x2 += k7;
					x1 += i7;
					c2 += l7;
			...
			y3 = anIntArray1472[y3];
			while (--y1 >= 0) {
				drawTexturedScanline(Raster.pixels, texels, y3, x3 >> 16, x2 >> 16, c3, c2, l4, k5, j6, i5, l5, k6, z3, depthSlope);
				z3 += depthScale;
				x2 += k7;
				x3 += i8;
				c2 += l7;
			...
			while (--y2 >= 0) {
				drawTexturedScanline(Raster.pixels, texels, y3, x1 >> 16, x2 >> 16, c1, c2, l4, k5, j6, i5, l5, k6, z3, depthSlope);
				z3 += depthScale;
				x2 += k7;
				x1 += i7;
				c2 += l7;
		...
		if (k7 < i8) {
			...
			y3 = anIntArray1472[y3];
			while (--y2 >= 0) {
				drawTexturedScanline(Raster.pixels, texels, y3, x1 >> 16, x3 >> 16, c1, c3, l4, k5, j6, i5, l5, k6, z3, depthSlope);
				z3 += depthScale;
				x1 += k7;
				x3 += i8;
				c1 += l7;
		...
		y3 = anIntArray1472[y3];
		while (--y2 >= 0) {
			drawTexturedScanline(Raster.pixels, texels, y3, x3 >> 16, x1 >> 16, c3, c1, l4, k5, j6, i5, l5, k6, z3, depthSlope);
			z3 += depthScale;
			x1 += k7;
			x3 += i8;
			c1 += l7;
	...
	public static void drawTexturedTriangle(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		int var21;
		int[] texturePixels = method371(var18);
		aBoolean1463 = !aBooleanArray1475[var18];
		var21 = var4 - var3;
		int var26 = var1 - var0;
		int var27 = var5 - var3;
		int var31 = var2 - var0;
		...
		if(var32 != 0) {
			...
			var14 -= var12;
			var17 -= var15;
			final int FOV = (aBoolean1464 ? SceneGraph.focalLength : 512);
			...
			if(var0 <= var1 && var0 <= var2) {
				if(var0 < Raster.bottomY) {
					if(var1 > Raster.bottomY) {
						var1 = Raster.bottomY;
					}

					if(var2 > Raster.bottomY) {
						var2 = Raster.bottomY;
					}
					...
					if(var1 < var2) {
							...
							while(true) {
								...
								if(var1 < 0) {
									while(true) {
										...
										drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var0, var4 >> 16, var5 >> 16, var6, var41, var24, var36, var33, var38, var39, var40);
										var5 += var22;
										var4 += var30;
										var6 += var20;
										var0 += Raster.width;
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var0, var3 >> 16, var5 >> 16, var6, var41, var24, var36, var33, var38, var39, var40);
								var5 += var22;
								var3 += var29;
								var6 += var20;
								var0 += Raster.width;
							...
							while(true) {
								...
								if(var1 < 0) {
									while(true) {
										...
										drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var0, var5 >> 16, var4 >> 16, var6, var41, var24, var36, var33, var38, var39, var40);
										var5 += var22;
										var4 += var30;
										var6 += var20;
										var0 += Raster.width;
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var0, var5 >> 16, var3 >> 16, var6, var41, var24, var36, var33, var38, var39, var40);
								var5 += var22;
								var3 += var29;
								var6 += var20;
								var0 += Raster.width;
						...
						if((var0 == var2 || var22 >= var29) && (var0 != var2 || var30 <= var29)) {
							...
							while(true) {
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var0, var3 >> 16, var4 >> 16, var6, var41, var24, var36, var33, var38, var39, var40);
								var4 += var22;
								var3 += var29;
								var6 += var20;
								var0 += Raster.width;
							...
							while(true) {
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var0, var4 >> 16, var3 >> 16, var6, var41, var24, var36, var33, var38, var39, var40);
								var4 += var22;
								var3 += var29;
								var6 += var20;
								var0 += Raster.width;
					...
					if(var2 < var0) {
							...
							while(true) {
								...
								if(var2 < 0) {
									while(true) {
										...
										drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var1, var5 >> 16, var3 >> 16, var7, var41, var24, var36, var33, var38, var39, var40);
										var3 += var29;
										var5 += var22;
										var7 += var20;
										var1 += Raster.width;
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var1, var4 >> 16, var3 >> 16, var7, var41, var24, var36, var33, var38, var39, var40);
								var3 += var29;
								var4 += var30;
								var7 += var20;
								var1 += Raster.width;
							...
							while(true) {
								...
								if(var2 < 0) {
									while(true) {
										...
										drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var1, var3 >> 16, var5 >> 16, var7, var41, var24, var36, var33, var38, var39, var40);
										var3 += var29;
										var5 += var22;
										var7 += var20;
										var1 += Raster.width;
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var1, var3 >> 16, var4 >> 16, var7, var41, var24, var36, var33, var38, var39, var40);
								var3 += var29;
								var4 += var30;
								var7 += var20;
								var1 += Raster.width;
						...
						if(var29 < var30) {
							...
							while(true) {
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var1, var5 >> 16, var4 >> 16, var7, var41, var24, var36, var33, var38, var39, var40);
								var5 += var29;
								var4 += var30;
								var7 += var20;
								var1 += Raster.width;
							...
							while(true) {
								...
								drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var1, var4 >> 16, var5 >> 16, var7, var41, var24, var36, var33, var38, var39, var40);
								var5 += var29;
								var4 += var30;
								var7 += var20;
								var1 += Raster.width;
				...
				if(var0 < var1) {
						...
						while(true) {
							...
							if(var0 < 0) {
								while(true) {
									...
									drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var2, var4 >> 16, var3 >> 16, var8, var41, var24, var36, var33, var38, var39, var40);
									var4 += var30;
									var3 += var29;
									var8 += var20;
									var2 += Raster.width;
							...
							drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var2, var4 >> 16, var5 >> 16, var8, var41, var24, var36, var33, var38, var39, var40);
							var4 += var30;
							var5 += var22;
							var8 += var20;
							var2 += Raster.width;
						...
						while(true) {
							...
							if(var0 < 0) {
								while(true) {
									...
									drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var2, var3 >> 16, var4 >> 16, var8, var41, var24, var36, var33, var38, var39, var40);
									var4 += var30;
									var3 += var29;
									var8 += var20;
									var2 += Raster.width;
							...
							drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var2, var5 >> 16, var4 >> 16, var8, var41, var24, var36, var33, var38, var39, var40);
							var4 += var30;
							var5 += var22;
							var8 += var20;
							var2 += Raster.width;
					...
					if(var30 < var22) {
						...
						while(true) {
							...
							drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var2, var3 >> 16, var5 >> 16, var8, var41, var24, var36, var33, var38, var39, var40);
							var3 += var30;
							var5 += var22;
							var8 += var20;
							var2 += Raster.width;
						...
						while(true) {
							...
							drawTexturedLine(Raster.pixels, texturePixels, 0, 0, var2, var5 >> 16, var3 >> 16, var8, var41, var24, var36, var33, var38, var39, var40);
							var3 += var30;
							var5 += var22;
							var8 += var20;
							var2 += Raster.width;
