...
//        personalStores(textDrawingAreas);
    ...
    private static void bankVault(TextDrawingArea[] tda) {
        ...
        addSprite(56301, 862);
        addText(56302, "RunePK Bank Vault", tda, 2, 0xFFA500, true, true);
    ...
    private static void achievementInterface(TextDrawingArea[] tda) {
        ...
        addSprite(56801, 861);
        addText(56802, "RunePK Achievements", tda, 2, 0xFFA500, true, true);
    ...
    private static void welcome(TextDrawingArea[] TDA) {
        ...
        addSprite(21300, 778);
        addHoverButton(21301, 298, 367, 45, "Enter RunePK", -1, 21302, 1);
        ...
        addText(21311, "WELCOME TO RUNEPK!", 0xE9EBC5, true, true, 52, TDA, 3);
        ...
        addText(21315, "RunePK is dope as fuck!", 0x000000, true, false, 52, TDA, 0);
        addText(21316, "RunePK is dope as fuck!", 0x000000, true, false, 52, TDA, 0);
        addText(21317, "RunePK is dope as fuck!", 0x000000, true, false, 52, TDA, 0);
...
//            addDropdownMenu(26811, 136, 0, false, true, Dropdown.DEFAULT, "10", "100", "1,000", "10,000", "100,000");
  ...
  //          addDropdownMenu(26811, 150, -1, false, false, Dropdown.KEYBINDING, "None", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "ESC");
    ...
    private static void starter(TextDrawingArea[] daniel) {
        ...
        addSprite(45001, 275);
        addText(45002, "RunePK Account Setup", 0xff9933, true, true, 52, daniel, 2);
    ...
    private static void bank(TextDrawingArea[] tda) {
        ...
        addText(interfaceId + 5, "The Bank of RunePK", tda, 2, 0xFF981F, true, true);
...
//        bank.child(60, interfaceId + 78, 19, 240);
    ...
    private static void clanChat(TextDrawingArea[] tda) {
        ...
        addSprite(33501, 67);
        addText(33502, "RunePK", tda, 3, 0xDE8B0D, true, true);
        addSprite(33503, 68);
    ...
    public static void equipmentTab(TextDrawingArea[] wid) {
        ...
        addHoverButton(27660, 152, 39, 40, "Open Presets", -1, 27661, 1);
    ...
    private static void informationTab(TextDrawingArea tda[]) {
        ...
        addSprite(29401, 63);
        addSprite(29402, 64);
        addText(29403, "RunePK | v" + Configuration.GAME_VERSION, tda, 2, 0xC47423, false, true);
        addHoverText(29404, "www.RunePK.io", "Visit website", tda, 3, 0xC47423, true, true, 168);
    ...
    private static void toolPanel(TextDrawingArea tda[]) {
        ...
        addHoverText(35414, "www.RunePK.io", "Visit website", tda, 3, 0xC47423, true, true, 168);
